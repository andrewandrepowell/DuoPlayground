...
namespace Pow.Utilities
{
    ...
    public enum Layers { FarSky, MidSky, CloseSky, FarMountain, MidMountain, CloseMountain, FarTree, MidTree, Background, Ground, Protag, Foreground, Interface, Dimmer, Menu, Box }
